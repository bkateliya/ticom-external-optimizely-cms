...
const COLOR_GROUPS: { name: string; note?: string; swatches: Swatch[] }[] = [
  {
    ...
    swatches: [
      ...
      {
        label: "text-color-primary-contrast",
        cls: "bg-pl-text-color-primary-contrast",
      },
      { label: "text-color-secondary", cls: "bg-pl-text-color-secondary" },
      {
        label: "text-color-secondary-contrast",
        cls: "bg-pl-text-color-secondary-contrast",
      },
      { label: "text-color-accent", cls: "bg-pl-text-color-accent" },
      {
        label: "text-color-accent-contrast",
        cls: "bg-pl-text-color-accent-contrast",
      },
      { label: "text-color-disabled", cls: "bg-pl-text-color-disabled" },
      {
        label: "text-color-disabled-contrast",
        cls: "bg-pl-text-color-disabled-contrast",
      },
    ],
  },
  {
    ...
    swatches: [
      ...
      {
        label: "link-color-primary-contrast",
        cls: "bg-pl-link-color-primary-contrast",
      },
      { label: "link-color-secondary", cls: "bg-pl-link-color-secondary" },
      {
        label: "link-color-secondary-contrast",
        cls: "bg-pl-link-color-secondary-contrast",
      },
      { label: "link-color-tertiary", cls: "bg-pl-link-color-tertiary" },
      { label: "link-color-accent", cls: "bg-pl-link-color-accent" },
      {
        label: "link-color-accent-contrast",
        cls: "bg-pl-link-color-accent-contrast",
      },
    ],
  },
  {
    ...
    swatches: [
      {
        label: "element-color-primary-lighter",
        cls: "bg-pl-element-color-primary-lighter",
      },
      { label: "element-color-primary", cls: "bg-pl-element-color-primary" },
      {
        label: "element-color-primary-darker",
        cls: "bg-pl-element-color-primary-darker",
      },
      {
        label: "element-color-secondary-lighter",
        cls: "bg-pl-element-color-secondary-lighter",
      },
      {
        label: "element-color-secondary",
        cls: "bg-pl-element-color-secondary",
      },
      {
        label: "element-color-secondary-darker",
        cls: "bg-pl-element-color-secondary-darker",
      },
      {
        label: "element-color-tertiary-lighter",
        cls: "bg-pl-element-color-tertiary-lighter",
      },
      { label: "element-color-tertiary", cls: "bg-pl-element-color-tertiary" },
      {
        label: "element-color-tertiary-darker",
        cls: "bg-pl-element-color-tertiary-darker",
      },
      { label: "element-color-disabled", cls: "bg-pl-element-color-disabled" },
      {
        label: "element-color-disabled-variant",
        cls: "bg-pl-element-color-disabled-variant",
      },
      { label: "element-color-contrast", cls: "bg-pl-element-color-contrast" },
      {
        label: "element-color-contrast-variant",
        cls: "bg-pl-element-color-contrast-variant",
      },
      {
        label: "element-color-contrast-disabled",
        cls: "bg-pl-element-color-contrast-disabled",
      },
      {
        label: "element-color-contrast-disabled-variant",
        cls: "bg-pl-element-color-contrast-disabled-variant",
      },
    ],
  },
  {
    ...
    swatches: [
      ...
      {
        label: "button-primary-color-hover",
        cls: "bg-pl-button-primary-color-hover",
      },
      {
        label: "button-primary-color-active",
        cls: "bg-pl-button-primary-color-active",
      },
      {
        label: "button-primary-text-color",
        cls: "bg-pl-button-primary-text-color",
      },
      { label: "button-secondary-color", cls: "bg-pl-button-secondary-color" },
      {
        label: "button-secondary-color-hover",
        cls: "bg-pl-button-secondary-color-hover",
      },
      {
        label: "button-secondary-color-active",
        cls: "bg-pl-button-secondary-color-active",
      },
      {
        label: "button-secondary-text-color",
        cls: "bg-pl-button-secondary-text-color",
      },
      {
        label: "button-tertiary-text-color",
        cls: "bg-pl-button-tertiary-text-color",
      },
      {
        label: "button-tertiary-text-color-hover",
        cls: "bg-pl-button-tertiary-text-color-hover",
      },
      {
        label: "button-tertiary-text-color-active",
        cls: "bg-pl-button-tertiary-text-color-active",
      },
      { label: "button-reversed-color", cls: "bg-pl-button-reversed-color" },
      {
        label: "button-reversed-color-active",
        cls: "bg-pl-button-reversed-color-active",
      },
      {
        label: "button-reversed-text-color-hover",
        cls: "bg-pl-button-reversed-text-color-hover",
      },
      { label: "button-disabled-color", cls: "bg-pl-button-disabled-color" },
      {
        label: "button-disabled-color-reverse",
        cls: "bg-pl-button-disabled-color-reverse",
      },
    ],
  },
  {
    ...
    swatches: [
      ...
      {
        label: "input-element-color-disabled",
        cls: "bg-pl-input-element-color-disabled",
      },
      { label: "input-text-color", cls: "bg-pl-input-text-color" },
      {
        label: "input-text-color-disabled",
        cls: "bg-pl-input-text-color-disabled",
      },
      { label: "input-border-color", cls: "bg-pl-input-border-color" },
      {
        label: "input-border-color-focus",
        cls: "bg-pl-input-border-color-focus",
      },
      { label: "input-background-color", cls: "bg-pl-input-background-color" },
      {
        label: "input-background-color-hover",
        cls: "bg-pl-input-background-color-hover",
      },
      {
        label: "input-background-color-disabled",
        cls: "bg-pl-input-background-color-disabled",
      },
      {
        label: "input-placeholder-color",
        cls: "bg-pl-input-placeholder-color",
      },
    ],
  },
  {
    ...
    swatches: [
      ...
      {
        label: "divider-color-primary-contrast",
        cls: "bg-pl-divider-color-primary-contrast",
      },
      {
        label: "divider-color-secondary",
        cls: "bg-pl-divider-color-secondary",
      },
      {
        label: "divider-color-secondary-contrast",
        cls: "bg-pl-divider-color-secondary-contrast",
      },
    ],
  },
  {
    ...
    swatches: [
      {
        label: "page-background-color-primary",
        cls: "bg-pl-page-background-color-primary",
      },
      {
        label: "page-background-color-secondary",
        cls: "bg-pl-page-background-color-secondary",
      },
      {
        label: "container-background-color-primary",
        cls: "bg-pl-container-background-color-primary",
      },
      {
        label: "container-background-color-primary-variant",
        cls: "bg-pl-container-background-color-primary-variant",
      },
      {
        label: "container-background-color-secondary",
        cls: "bg-pl-container-background-color-secondary",
      },
      {
        label: "container-background-color-secondary-variant",
        cls: "bg-pl-container-background-color-secondary-variant",
      },
      {
        label: "container-background-color-tertiary",
        cls: "bg-pl-container-background-color-tertiary",
      },
      {
        label: "container-background-color-tertiary-variant",
        cls: "bg-pl-container-background-color-tertiary-variant",
      },
    ],
  },
  {
...
function Section({
  ...
  return (
    <section id={slugify(title)} className="mb-16 scroll-mt-24">
      <h2 className="mb-6 border-b border-pl-border-color-tertiary pb-2">
        {title}
      </h2>
      {children}
    </section>
...
function Spec({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-body-sm text-pl-input-placeholder-color mb-1">
      {children}
    </p>
  );
}
  ...
  return (
    ...
    >
        ...
        <div className="mt-6">
          ...
          <div className="mb-6">
            ...
            <p className="mb-0">
              ...
              <a
                href="#"
                className="text-pl-link-color-primary hover:underline"
              >
                standard link
              </a>{" "}
        ...
        <div className="mt-4">
          {SPACING.map((s) => (
            <div key={s.label} className="flex items-center gap-4 mb-1">
              ...
              <span className="text-body-sm text-pl-input-placeholder-color mb-0 w-12">
                {s.px}
              </span>
              <div
                className={`${s.cls} h-4 bg-pl-element-color-primary rounded`}
              />
            </div>
          ))}
        </div>
      ...
      <Section title="Radius">
        <Spec>
          TI is a square system — rounded (2px) is the default for UI.
        </Spec>
      ...
      <Section title="Elevation">
        ...
        <div className="flex flex-wrap gap-8 mt-6">
          <div className="shadow-1 bg-pl-page-background-color-primary rounded p-6 w-40">
            shadow-1
          </div>
          <div className="shadow-2 bg-pl-page-background-color-primary rounded p-6 w-40">
            shadow-2
          </div>
          <div className="shadow-3 bg-pl-page-background-color-primary rounded p-6 w-40">
            shadow-3
          </div>
          <div className="shadow-4 bg-pl-page-background-color-primary rounded p-6 w-40">
            shadow-4
          </div>
        </div>
      </Section>
...
>
  View products
        ...
        <div className="mb-6">
          <Spec>
            Sizes — appearance=&quot;solid&quot; color=&quot;primary&quot;
          </Spec>
          <div className="flex flex-wrap items-center gap-3">
