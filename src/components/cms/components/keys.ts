...
export const AllComponentTypeKeyMap = {
  ...
  AuthoredCardComponent: `${KEY_PREFIX}GeneralCard_Component`,
  MixedCardListComponent: `${KEY_PREFIX}GeneralCards_Component`,
  ...
  PremiumInteractiveImageComponent: `${KEY_PREFIX}PremiumInteractiveImage_Component`,
  PremiumInteractiveImagePanelComponent: `${KEY_PREFIX}PremiumInteractiveImagePanel_Component`,
  ...
  GenericPageHeadingComponent: `${KEY_PREFIX}GenericPageHeading_Component`,
  ...
  EventsResultListComponent: `${KEY_PREFIX}EventsResultList_Component`,
